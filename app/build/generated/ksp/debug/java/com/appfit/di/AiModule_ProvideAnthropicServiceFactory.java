...
public final class AiModule_ProvideAnthropicServiceFactory implements Factory<AnthropicService> {
  ...
  public AiModule_ProvideAnthropicServiceFactory(Provider<ApiKeyProvider> apiKeyProvider,
  ...
  @Override
  public AnthropicService get() {
    return provideAnthropicService(apiKeyProvider.get(), debugLoggerProvider.get(), toolApprovalManagerProvider.get(), activityRepositoryProvider.get(), dietRepositoryProvider.get(), userProfileProvider.get());
  }

  public static AiModule_ProvideAnthropicServiceFactory create(
      Provider<ApiKeyProvider> apiKeyProvider, Provider<AiDebugLogger> debugLoggerProvider,
      Provider<ToolApprovalManager> toolApprovalManagerProvider,
      Provider<ActivityRepository> activityRepositoryProvider,
      Provider<DietRepository> dietRepositoryProvider,
      Provider<UserProfileProvider> userProfileProvider) {
    return new AiModule_ProvideAnthropicServiceFactory(apiKeyProvider, debugLoggerProvider, toolApprovalManagerProvider, activityRepositoryProvider, dietRepositoryProvider, userProfileProvider);
  }

  public static AnthropicService provideAnthropicService(ApiKeyProvider apiKeyProvider,
    ...
    return Preconditions.checkNotNullFromProvides(AiModule.INSTANCE.provideAnthropicService(apiKeyProvider, debugLogger, toolApprovalManager, activityRepository, dietRepository, userProfileProvider));
  }
}
