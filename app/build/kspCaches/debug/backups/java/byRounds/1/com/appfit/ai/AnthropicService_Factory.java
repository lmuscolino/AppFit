...
public final class AnthropicService_Factory implements Factory<AnthropicService> {
  ...
  public AnthropicService_Factory(Provider<ApiKeyProvider> apiKeyProvider,
  ...
  public static AnthropicService_Factory create(Provider<ApiKeyProvider> apiKeyProvider,
      Provider<AiDebugLogger> debugLoggerProvider,
      Provider<ToolApprovalManager> toolApprovalManagerProvider,
      Provider<ActivityRepository> activityRepositoryProvider,
      Provider<DietRepository> dietRepositoryProvider,
      Provider<UserProfileProvider> userProfileProvider) {
    return new AnthropicService_Factory(apiKeyProvider, debugLoggerProvider, toolApprovalManagerProvider, activityRepositoryProvider, dietRepositoryProvider, userProfileProvider);
  }

  public static AnthropicService newInstance(ApiKeyProvider apiKeyProvider,
    ...
    return new AnthropicService(apiKeyProvider, debugLogger, toolApprovalManager, activityRepository, dietRepository, userProfileProvider);
  }
}
